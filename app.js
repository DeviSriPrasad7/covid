...
app.post("/districts/", async (request, response) => {
  ...
  const districtsArray = await database.run(postDistrictsQuery);
...
app.get("/districts/:districtId/", async (request, response) => {
  ...
  const responseQuery = await database.get(getDistrictQuery);
  response.send(convertDistrictDbObjectToResponseObject(responseQuery));
});
